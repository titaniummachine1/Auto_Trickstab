...
local function SimulateWalkingInDirections(player)
    ...
    for direction = 1, NUM_DIRECTIONS do
        ...
        endPositions[angle] = PredictPlayer(player, simulatedVelocity) -- Store all positions for this direction
    end
...
local function OnCreateMove(cmd)
    ...
    local currentWarps = SimulateWalkingInDirections(cachedLocalPlayer)
...
local function doDraw()
    ...
    -- Drawing the simulated positions on screen
